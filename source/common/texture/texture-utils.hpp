...
namespace our::texture_utils
{
    ...
    // This function creates a texture from raw image data
    Texture2D *createFromData(int width, int height, int channels, const unsigned char *data, bool generate_mipmap = true);
}