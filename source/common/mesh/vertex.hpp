...
namespace our
{
    ...
    struct Vertex
    {
        ...
        glm::uvec4 joints = glm::uvec4(0);   // Skinning joint indices
        glm::vec4 weights = glm::vec4(0.0f); // Skinning weights
...
namespace std
{
    ...
    struct hash<our::Vertex>
    {
        size_t operator()(our::Vertex const &vertex) const
        {
            ...
            combined = hash_combine(combined, hash<glm::uvec4>()(vertex.joints));
