...
* **Phase -1 Delivery:** Week 6 Monday 16th March 2026 23:59. 
* **Game Proposal:** Week 8 Monday 30th March 2026 23:59.
* **Phase 1 Delivery:** Week 8 Monday 30th March 2026 23:59. 
* **Phase 1 Discussion:** During the tutorials in Week 8. 
* **Phase 2 Delivery:** Week 12 Monday 27th April 2026 23:59. 
* **Phase 2 Discussion:** During the tutorial in Week 12. 
---

## Game Proposal Document

By Week 8 Monday 30th March 2026 23:59, you should submit a game proposal. It should contain a game name, a paragraph describing the game and an image demonstrating the game idea. The description should describe how the game will be played and what is the goal of the game. Don’t forget to add the team member names, IDs and team number. Some example proposals are included in the appendix. Only one member of each team needs to deliver the game proposal on Google Classroom.


## Game Proposal Guidelines

### 1. Use Real 3D Objects (Meshes), Not Only Simple Shapes

Your game should use actual 3D meshes rather than only primitive shapes such as cubes or basic geometry.

- Imported 3D models (characters, props, environment objects) ✔ Acceptable
- A game composed mainly of cubes, spheres, or simple primitives. ✘ Not acceptable

### 2. Include Meaningful Interaction

- The game should contain clear interactions with enemies or the environment.
- Games where the player only moves around without interacting are considered too simple.

### 3. Have Dynamic Elements in the World

There should be moving or dynamic objects besides the player.

Examples:
- Enemies moving in the scene
- Moving obstacles
- Platforms or traps
- Objects reacting to the player

Static environments with only a moving player are insufficient.

### 4. Ensure Significant Camera Motion

The game must include noticeable camera movement. Camera that moves dynamically with the scene

✘ Not acceptable:
A completely fixed camera showing the whole scene.

### 5. Avoid Overly Simple Game Logic

The core gameplay should contain multiple mechanics, not just a single simple action.

Examples of improvements:
- Enemy interaction
- Shooting mechanics
- Obstacles affecting movement
- Multiple gameplay states

### 6. Start with a Small Prototype First

Before building the full game, implement a minimal working version.

Example:
1. Build one room or one level
2. Implement all gameplay mechanics
3. Then expand to the full game world

### 7. Implement Basic Collision / Hit Detection

If your game includes shooting or attacks, you must implement hit detection.
Example methods:
- Ray casting
- Collision detection
- Bullet tracing
...
Phase -1 should be delivered on Week 6 Monday 16th March 2026 23:59. It should be delivered on Google Classroom.
...
Phase 1 should be delivered on Monday 30th March 2026 23:59 and discussed in the tutorial during Week 8. 
...
Phase 2 should be delivered on Monday 27th April 2026 23:59 and discussed in the tutorial during Week 12.
